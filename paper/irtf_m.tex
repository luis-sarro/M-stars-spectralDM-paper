...
\begin{document} 
   ...
   \title{Effective temperatures, gravities and metallicities for M type stars in the IRTF database.}

   \subtitle{I. An approach from the Machine Learning Arena}

   \author{L. Sarro-Baro \inst{1}  
          \and
...
% The problem of estimation of stellar parameters in the M regime. who and what. Teff calibrations
...
\section{Regression models for parameter estimation}
\input{regression}


\section{Physical parameters foreseen for IRTF M-type stars}
% \input{ipac}
