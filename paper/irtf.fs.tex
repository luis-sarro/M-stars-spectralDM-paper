...
The application of the GAs to the IRTF wavelength range and resolution
results in included in Table~\ref{tab:tab_NC_T}. Features are ordered
by the fitness value (the AIC) and we only consider features that are
