...
\begin{document} 
   ...
   \title{Effective temperatures, gravities and metallicities for M type stars in the IPAC database.}

   \subtitle{I. The I band perspective}
...
\section{Physical parameters for the sample of IPAC M-type stars}
% \input{ipac}
